...
export default class LoginScreen extends Component {
    ...
    onSignIn = googleUser => {
        //Necesitamos registrar un observador en la autorización de Firebase para asegurarnos que la autorización esté inicializada.  
        var unsubscribe = firebase.auth().onAuthStateChanged(firebaseUser => {
            ...
            if (!this.isUserEqual(googleUser, firebaseUser)) {
                ...
                //Iniciar sesión con credenciales del usuario de Google.
                firebase
                    .auth()
                    ...
                    .catch(error => {
                        ...
                        //El correo del usuario utilizado.
                        var email = error.email;
                        //El tipo de firebase.auth.AuthCredential fue usado.
